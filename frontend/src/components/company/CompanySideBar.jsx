    ...
    >
      ...
      <nav className="flex flex-col justify-between h-full">
        <ul className="space-y-4 flex-grow p-4">
          <li>
            <Link to="/company" className="block px-4 py-2 rounded hover:bg-gray-800">
              Profile
            </Link>
          </li>
          <li>
            <Link to="/company/jobs" className="block px-4 py-2 rounded hover:bg-gray-800">
              Jobs
            </Link>
          </li>
          <li>
            <Link to="/company/students" className="block px-4 py-2 rounded hover:bg-gray-800">
              Students
            </Link>
          </li>
        </ul>
